		...
		<div class="main_parametrs_group_div closed_params " >
			...
			<div class="inside_information_div">
				...
				<tbody> 
               		<tr>
						<td>
							Show the Form<span class="pro_feature"> (pro)</span> <span title="Use this option to show or hide Subscribe Form from Coming soon page." class="desription_class">?</span>
						</td>
						<td>
                    ...
                    <tr>
						<td>
							First name field text<span class="pro_feature"> (pro)</span> <span title="Type here text for first name field." class="desription_class">?</span>
						</td>
						<td>
                    ...
                    <tr>
						<td>
							Last name field text<span class="pro_feature"> (pro)</span> <span title="Type here text for last name field." class="desription_class">?</span>
						</td>
						<td>
                    ...
                    <tr>
                     ...
                     <tr>
						<td>
							Invalid email text<span class="pro_feature"> (pro)</span> <span title="Type here message that will appear after users submit invalid email." class="desription_class">?</span>
						</td>
						<td>
                    ...
                    <tr>
                     ...
                     <tr>
						<td>
							 Input maximum width<span class="pro_feature"> (pro)</span> <span title="Type here maximum with for input field." class="desription_class">?</span>
						</td>
						<td>
